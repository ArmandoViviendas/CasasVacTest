...
<div class="row" id="contenedor">
				...
				<form class="form-inline">
					<select class="chosen" style="width:200px;height: 30px">
					  ...
					  <div class="form-group">
					    ...
					    <input type="password" class="form-control" id="datepicker2">
					  </div>
    ...
    <div class="row">
    	<div class="col-md-12" >
				<div class="col-md-8" id="contenedor4" ></div>
				<div class="col-md-4">
						<div class="row">
						<div class="col-md-12" id="col"	style="position:fixed !important;width: 100%"></div>
					</div>
				</div>
      	...
      	<div class="col-md-12">
      		<div class="col-md-9">
      			<div class="col-md-12">
      				...
      				<hr>
      				<!--<div class="row" id="filtrosTipo">
      				<div class="col-md-2"><label>Tipo de Casa</label></div>
      					<div class="col-md-12">
	      						
	      						
	      						<div class="col-md-2" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Casa&nbsp;<span class="glyphicon glyphicon-home"></span><input type="checkbox" value="">
	      						</p></div>
	      						<div class="col-md-3" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Departamento&nbsp;<span class="glyphicon glyphicon-home"></span><input type="checkbox" value=""></p></div>
	      						<div class="col-md-2" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Bungalow&nbsp;<span class="glyphicon glyphicon-home"></span><input type="checkbox" value=""></p></div>
	      						<div class="col-md-2" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Chalet&nbsp;<span class="glyphicon glyphicon-home"></span><input type="checkbox" value=""></p></div>
	      						<div class="col-md-2" style="background-color: 	 #d9d9d9; height: 50px;margin&nbsp;-right: 5px;"><p id="c">Villa&nbsp;<span class="glyphicon glyphicon-home"></span><input type="checkbox" value=""></p></div>
	      						<!--<div class="col-md-2"><label  class="checkbox-inline"><input style="margin-top: 5px;" type="checkbox" value="">Casa<span class="glyphicon glyphicon-home"></span></label></div>
	      						<div class="col-md-2"><label class="checkbox-inline"><input type="checkbox" value="">Departamento<span class="glyphicon glyphicon-home"></span></label></div>
	      						<div class="col-md-2"><label class="checkbox-inline"><input type="checkbox" value="">Bungalow<span class="glyphicon glyphicon-home"></span></label>   </div>
	      						<div class="col-md-2"><label class="checkbox-inline"><input type="checkbox" value="">Chalet<span class="glyphicon glyphicon-home"></span></label></div>
	      						<div class="col-md-2"><label class="checkbox-inline"><input type="checkbox" value="">Villa<span class="glyphicon glyphicon-home"></span></label></div>-->
      				...
      				<div class="col-md-2"><label>Extras</label></div>
      					<div class="col-md-12">
      						<div class="col-md-2" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Alberca&nbsp;<span class="glyphicon glyphicon-tint"></span><input type="checkbox" value="">
	      						</p></div>
	      						<div class="col-md-3" style="background-color: 	 #d9d9d9; height: 50px;margin-right: 5px;"><p id="c">Caldera&nbsp;<span class="glyphicon glyphicon-fire"></span><input type="checkbox" value=""></p></div>
