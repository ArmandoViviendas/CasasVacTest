			...
			success: function(data){
				...
				$.each(data, function(index,value){ 
					...
					if(value.descripcion.match(/Exterior/)  || value.descripcion.match(/exterior/)){
						imagen1 = imagen1 + '<li class="col-sm-3"><a class="thumbnail" id="carousel-selector-'+index+'"><img src="http://atlas.casasvacacionales.mx/static/cv/images/800x600/'+value.url+'"style="width:100%;height:100px;"></a></li>'
					}
